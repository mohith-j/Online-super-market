...
$sql = mysqli_query($conn,"SELECT * FROM admin "); // query the person
...
if ($productCount > 0) {
	while($row = mysqli_fetch_array($sql)){ 
			 ...
			 $product_list .= "Product ID: $id - <strong>$product_name</strong> - Rs $price - <em>Added $date_added</em> &nbsp; &nbsp; &nbsp; &bull; <a style='color:black' href='inventory_list.php?deleteid=$id'>delete</a><br />";
    }
} else {
    ...
    <table width="90%" border="0" cellspacing="0" cellpadding="6">
      ...
      <tr>
        ...
        <td><label>
          ...
          <option value="BNG">Beauty and Grooming</option>
