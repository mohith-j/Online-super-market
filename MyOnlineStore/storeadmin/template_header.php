<div id="pageHeader"><table width="100%" border="0" cellspacing="0" cellpadding="12">
  <tr>
    <td width="32%"><a href="../index.php"><img src="../images/logo.png" alt="Logo" width="252" height="36" border="0" /></a></td>
    <td width="68%" align="right"><a href="logoutadmin.php">Logout</a></td>
  </tr>
  <!-- <tr>
